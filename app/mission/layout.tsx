...
const NavBarMission = () => {
  return (
    ...
    <div className='flex justify-center text-white  gap-16 sm:gap-0 sm:justify-between items-center w-full fixed top-0  pt-8 pb-4 sm:py-8 px-4 sm:px-12 z-50 backdrop-blur-sm sm:backdrop-blur-none '>
        ...
        <div className='flex w-1/3 flex-row justify-end items-center text-lg gap-8 '>
            <Link href={"https://app.mystory.bio/sign-in"} className='ring-2 ring-white text-white text-xl rounded-3xl px-6 whitespace-nowrap py-2 transition-all duration-500 hover:bg-white hover:text-black'>
                <h3 className='text-sm sm:text-lg'>Sign In</h3>
            </Link>
        </div>
    </div>
  )
